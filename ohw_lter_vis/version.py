...
description = "ohw_lter_vis: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/ohw_lter_vis/blob/master/README.md

License
=======
``ohw_lter_vis`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/ohw_lter_vis"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'ohw_lter_vis': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
