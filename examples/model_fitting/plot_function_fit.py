...
# ------------
#
# First, we'll load some data into ohw_lter_vis.
...
# ---------------
#
# With ohw_lter_vis, models are created with the :ref:Model class.
