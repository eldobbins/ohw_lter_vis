...
# -*- coding: utf-8 -*-
#
# ohw_lter_vis documentation build configuration file, created by
...
htmlhelp_basename = 'ohw_lter_visdoc'
...
latex_documents = [
  ('index', 'ohw_lter_vis.tex', 'ohw_lter_vis Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'ohw_lter_vis', 'ohw_lter_vis Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'ohw_lter_vis', 'ohw_lter_vis Documentation',
   'Ariel Rokem', 'ohw_lter_vis', 'One line description of project.',
   'Miscellaneous'),
]
